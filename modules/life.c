...
// Συγκρίνει κελιά, από το πιο "πάνω" στο πιο "κάτω", και αν είναι στην ίδια "σειρά", τότε από το πιο "αριστερό" στο πιο "δεξιό"
...
// Αν value == true το προσθέτει στο set (που αν υπάρχει δεν αλλάζει κάτι) αλλιώς το αφαιρεί (που αν δεν υπάρχει δεν αλλάζει κάτι).
